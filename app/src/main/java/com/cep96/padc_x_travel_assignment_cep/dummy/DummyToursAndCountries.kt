...
fun getDummyToursAndCountries(): CountriesAndToursListVO{
    ...
    val countries = arrayListOf<CountryVO>(countryOne, countryTwo)
    ...
    val tours = arrayListOf(tourOne, tourTwo)

    return CountriesAndToursListVO(countries, tours)
